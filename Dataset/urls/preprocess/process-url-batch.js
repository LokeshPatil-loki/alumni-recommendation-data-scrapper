...
const urlGroup1 = urlArray.splice(0,200);
const urlGroup2 = urlArray.splice(0,100);
const urlGroup3 = urlArray.splice(0,50);
const urlGroup4 = urlArray.splice(0,50);

fs.writeFileSync("./batch-4[400]/url-group-1.json", JSON.stringify(urlGroup1));
fs.writeFileSync("./batch-4[400]/url-group-2.json", JSON.stringify(urlGroup2));
